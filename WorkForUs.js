...
function ValidateVacancyForm() {
    ...
    if (document.getElementById("ukResidentYes").checked == false && document.getElementById("ukResidentNo").checked == false) {
        document.getElementById("ukResidentError").innerHTML = "Please identify if you are a UK Resident";
        flag3 = false;
    }
    else {
    ...
    if (document.forms["VacancyApplicationForm"]["telNo"].value == "") {
        document.getElementById("telNoError").innerHTML = "Please input your telephone number";
        flag4 = false;
    }
        ...
        if (isNaN(telNo)) {//if its not a number..
            document.getElementById("telNoError").innerHTML = "Please ensure you input a number";
            flag4 = false;
        }
